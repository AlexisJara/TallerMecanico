...
urlpatterns = [
    ...
    path('catalogo/<int:id_servicio>', catalogo, name="catalogo"),
    ...
    #MECANICO
    path('agendar_hora/<int:id_hora>/', agendar_hora, name="agendar_hora"),
]
