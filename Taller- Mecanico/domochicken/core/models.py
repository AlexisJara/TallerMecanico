...
class HorasDiponibles(models.Model):
    id_Hora = models.BigAutoField(primary_key=True)
    fecha = models.DateTimeField()
    ...
    def __str__(self):
        return f"{self.fecha} - {self.fk_id_servicio.nombre_servicio}"

class Reserva(models.Model):
    id_reserva = models.BigAutoField(primary_key=True)
    fk_id_horadisponible = models.ForeignKey(HorasDiponibles,on_delete=models.CASCADE,)
    fk_id_usuario = models.ForeignKey(Usuario,on_delete=models.CASCADE,)
    def __str__(self):
        return f"{self.fk_id_usuario.nombre_usuario} - {self.fk_id_horadisponible.fk_id_servicio.nombre_servicio}"
